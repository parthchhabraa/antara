      ...
      {isOpen && (
        <div className="fixed inset-0 z-[85]">
          ...
          <motion.div
            ...
            className="absolute left-0 right-0 bottom-0 rounded-t-lg bg-[#1b1e2e] border-t border-white/10 shadow-2xl p-5 pb-9"
          >
            ...
            <p className="text-sm leading-relaxed text-gray-300 mt-2.5 m-0">
            ...
            <button
              onClick={onClose}
              className="w-full h-11 mt-5 rounded-lg bg-primary-600 text-white text-sm font-bold"
            >
              Got it, let's start
            </button>
          </motion.div>
