...
import { IconTrash, IconAlertTriangle } from "@/components/icons";
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[95]">
          ...
          >
            ...
            <p className="text-xs leading-relaxed text-gray-400 mt-3">
            ...
            <button
              ...
              onClick={onClose}
              disabled={deleting}
              className="w-full h-12 mt-5 rounded-lg bg-white/5 text-gray-300 font-semibold text-sm disabled:opacity-40"
            >
              Cancel
            </button>
            ...
            <motion.button
              ...
              disabled={deleting}
              whileTap={{ scale: 0.98 }}
              className={`w-full h-12 mt-2 rounded-lg font-bold text-sm transition-colors disabled:opacity-60 ${
