      ...
      <PageTransition>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Stage 1 — survey-derived stats, real data only</p>
            </div>
          </div>
          <button
            onClick={load}
        ...
        {insights && (
          <div className="space-y-5">
            {/* Sample size + trend */}
            <div className="p-4 rounded-lg bg-[#0F111A] border border-white/5">
              ...
              {insights.stats.unmappedCategories && Object.keys(insights.stats.unmappedCategories).length > 0 && (
                <div className="mt-3 p-2.5 rounded-sm bg-amber-500/10 border border-amber-500/25 text-xs text-amber-300">
            ...
            <div className="p-3.5 rounded-lg bg-primary-900/20 border border-primary-800/30 text-xs leading-relaxed text-gray-300">
